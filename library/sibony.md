...
Original notes [here](/library/sibony/chi){:target="_blank"}. 

---

When the author was at McKinsey, a client agreed with all the analysis but overturned the conclusion because he believed the U.S. dollar would appreciate, and ultimately won big as he had hoped; unfortunately, most decisions of this kind fail  
...
Intuition is ineffective in hiring: most interviewers are not HR specialists, and even those who are are unlikely to recruit repeatedly for the same position; few organizations systematically track the quality of their past hiring decisions. Unstructured interviews are a delusion of confidence  
...
Hindsight bias: psychologist Baruch Fischhoff demonstrated that after an event happens, most people overestimate the probability that they had assigned to it beforehand  
...
The jury theorem: when each person is more likely to be right than wrong, the probability that the majority is correct increases, reinforcing the majority opinion  
...
The setting for successful dialogue: participants have sufficiently diverse backgrounds; there is enough time to understand one another’s views; pure discussion is put on the agenda as one item and people are not forced to decide immediately; PowerPoint is banned (Sun Microsystems CEO Scott McNealy: if every company in the world simply banned PowerPoint, profits would soar; Amazon also does not use it, instead requiring a six-page memo written as a structured narrative, which everyone reads beforehand so that nobody can pretend to have read it); misleading comparisons are banned (one venture-capital firm prohibits expressions such as “the next WhatsApp” to avoid anchoring); a cooling-off period before decisions; investment decisions begin by listing assets and liabilities; an alternative option must be proposed for parallel comparison (decisions with multiple options fail far less often than simple yes-or-no decisions, 32% versus 52%); an alternative must be proposed on the assumption that the current proposal is entirely infeasible; try interpreting the data through a different story; conduct a premortem, assuming that the proposal ultimately failed and identifying the cause of death (this may be regarded as an improved version of the “designated adversary” method, since a designated adversary may hold back and not want to offend anyone); when confidentiality makes discussion with many people impossible, the decision-maker can use the locked memorandum method to “discuss” with his past self  
...
Get experts’ real opinions, rather than merely the polished views they put in writing: I understand that you have a duty to warn me of the risks, but ultimately I decide whether taking them is worthwhile. This can remain between the two of us and need not go on the record. I want to know whether, if this were your money, you would take the risk  
...
Reward the group: without incentives tied to group interests, everyone will simply pursue the highest individual bonus. See *Wiser: Getting Beyond Groupthink to Make Groups Smarter*
Seek free learning: make good decisions without having to risk spending money  
...
Shoot first, draw the target afterward: one CEO only told the story after it had become true, giving the strategy flexibility  
