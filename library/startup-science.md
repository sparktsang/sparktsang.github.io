...
The magic number (The "Aha!" Moment): how many times must a customer use the product before they fall in love with it? Ｗhat exact metric guarantees a customer falls in love with the product? For Dropbox, Uber, and Airbnb, it was the first use; For Facebook, it was adding 14 friends in 10 days. Get users to that number whenever possible. Following this principle, Twitter redesigned the first-time experience so that users selected their interests first and were then given recommendations, allowing them to quickly follow ten people in one go.  
