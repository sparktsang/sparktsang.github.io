...
Beware of experts who tell stories. Their opinions have nothing to do with expectancy and do not constitute actionable knowledge; they are all noise, and the more authoritative they seem, the more dangerous they are: economics, like religion, is built on belief, and choosing among schools of thought is even less scientific. Their motive is simply to win your trust and fleece you. Reifschneider and Tulip's 2017 report, *The Federal Reserve's Approach*, proves that economists are unable to make forecasts  
...
The following tests basically all use P24, covering 40 years of historical data, with $51 per trade, using both long and short directions (for short trades, every operating condition is the opposite of the long side; only long-side operating conditions are described below, and opposite exit conditions are not stated), entering at the next day's open once the conditions are met. The Pat Hearne's 1% rule lost money because of changes over time; all the other trend strategies were profitable. The better ones were  
(strategy, cumulative net profit, number of trades, average net profit, entry condition, exit condition)  
50/200-Day Moving Average Crossover, $1.72M, 1,235, $1,389, SMA50>SMA200  
...
Then remove those with a return-risk ratio ≤2 or UPI≤.5. The four eliminated strategies were disappointing in CAGR, maximum drawdown duration, and R²  
...
The remaining top ten are ranked by CAGR: Monthly Close, Bollinger, Turtle, Dow Theory, Four-Week  
The 52-Week strategy fell to ninth because its stop-loss was too large, leaving its CAGR at only 10%. It is a pity because its R² reached 98% and its maximum drawdown duration was the second shortest  
...
The results show that the weekly version is superior to the daily version in almost every respect, with lower drawdowns and higher profits, while the monthly version is even more stable, though its CAGR is lower than the other two  
...
Next, following the principle of selling weakness, the strategy was adjusted again: an initial stop-loss was introduced, exiting when the low of the daily setup candle or entry candle was broken, whichever was farther away. This applies to the daily, weekly, and monthly strategies  
...
Finally, the author points out that the weekly Dow strategy incorporating both loss filtering and an initial stop-loss reduces risk and drawdown compared with the Turtle strategy while increasing returns, with a CAGR of 29%  
