...
Original notes [here](/library/least-resistance/chi){:target="_blank"}. 

---

Boston's roads were originally paths carved out by cattle. The cattle had neither consciousness nor a plan; they simply chose, step by step, the easiest places to walk. Water likewise follows the path of least resistance.

Three great insights about life:

1. Life is like a river: like everything else in the natural world, it follows the path of least resistance.
2. The path of least resistance is determined by the hidden structures in your life.
   Just as the direction of a river's flow is determined by the structure of the riverbed beneath it.
3. The fundamental hidden structure of life can be changed, allowing the river to flow in accordance with your wishes.

Structure determines behavior. To achieve a particular outcome, you must change the underlying structure.
...
The problem-solving mindset is even more deeply ingrained: what candidates reiterate to the public is always a pile of problems.
Yet the greatest leaders and statesmen in history were not problem-solvers but creators.
The famine in Ethiopia prompted massive donations and emergency relief, and indeed many people were saved. But the forces governing the situation did not change. As conditions improved, the urgency cooled and donations declined, while the problem continued.
A problem appears, triggering problem-solving action; the problem improves, which causes problem-solving action to decline; eventually the problem still exists.
The same is true of life. If you treat problem-solving as a way of life, you are destined to fail.
Many people regard creativity as solving difficult problems in some unusual way. In fact, problem-solving and creation are two entirely different things.
The Africa Food and Peace Foundation trained villagers in Uganda to create the lives they wanted, and succeeded. Compared with previous relief spending, the cost of this program was a drop in the bucket.
The program focused on what people wanted rather than what they did not want. For example, if they wanted a clean water source, they would find one and protect it.
If you do not know how to create what you want, you will always be confronted by a succession of new problems. Only creation allows you to avoid problems.

### What Is Creation?

Creation is different from compliance–resistance or problem-solving. It does not arise from the environment in which you find yourself; the creative activity itself is its driving force.
Skills can be acquired through learning and cultivation, and the steps are easy to describe, but they do not constitute a formula that can simply be applied.

1. Clarify what you want to create
   This is a skill. What schools teach is merely how to choose the correct way to conform from among the limited choices available in life, which has little to do with what we want.

2. Keep track of progress
   When painting, if you do not know how much you have painted, you will not know how to finish. Only by objectively examining reality can you take control of your creative process.

3. Take action
   Take the creative idea as the goal, observe how the results change, and you will know what to do next.
   Alongside trial-and-error, you are also cultivating your intuition.
...
5. Accumulate creative momentum
   Every act of innovation accumulates experience and knowledge; a first work becoming an instant sensation is not the norm.
...
In the same year that the airplane was invented, astronomer Simon Newcomb said that flight had been logically proven impossible.
In 1945, Admiral William Leahy told the President that an atomic bomb was impossible because atoms could not be split.
Napoleon dismissed the steam engine, telling its inventor that the idea of a steam engine was pure fantasy.
...
Wanting to change that belief likewise creates an opposing structural tension.
Even if you want to abandon all desire, the less you desire, the easier it becomes to have desires.
Trying to change a structure from within the structure itself is always futile. Actions taken to resolve structural conflict will only make you increasingly constrained, while the structure becomes increasingly entrenched. This is the nature of structure.
...
2. Control the conflict
   ...
   As always, once the pressure decreases, motivation weakens with it.
   The path of least resistance will soon carry them away from the outcomes they want. The long-term effect of this strategy is to reinforce people's sense of powerlessness.
   The formulas for controlling conflict are always the same: fear, guilt, and sympathy.
   The more extreme the conflict, the more extreme the action; terrorists are the archetypal example.
...
In the creative process, the gap between the vision and the current reality constitutes the most important structure, called “structural tension.”
The larger the gap, the more creative power can be harnessed; the smaller the gap, the more the tension tends toward release.
Once this new structure becomes dominant, the path of least resistance will also change.
The new structure is better able to integrate conflicts and turn complex structures into simple ones.
Situations that may reduce tension: compromising with reality, allowing the current state to continue; misunderstanding the current state, indulging in fantasies detached from reality.
Vision, the best starting point for the creative process, is the endpoint.
First comes the concept, then the vision. The former is general, while the latter is concrete and rich in detail: the first lesson of a creative technology course is to have students conceive the outcome they want to create.
Life itself may also be a creation, and a creation exists independently of you.
Again, many people confuse what they want with what is possible. Many plans produce poor results because people do not know what they truly want.
